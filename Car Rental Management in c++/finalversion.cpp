...
void deleteCar(string licensePlate);//self explanatory
      ...
      if (who == "ADMIN")
      {
         ...
         while (true)
         {
            ...
            else if (option == "5") // to get cash reports__________________
            {
               ...
               //    }
               // }
               int resoluteinc = netincome - abs(miscexp);
            ...
            else if (option == "11")
            {
               ...
               starspaces();
               cout << "Enter which car you want to delete: ";
               string op12lp;
               cin >> op12lp;
               deleteCar(op12lp);
               clearScreen();
...
void deleteCar(string licensePlate) // to delete car
{
   string category;
   cout << "Enter category(Economical/Luxury/Sedan/SUV): ";
   cin >> category;
   if (category == "Economical")
   {
      int tempval = -1;
   ...
   else if (category == "Luxury")
   {
      ...
      for (int i = 0; i < addcar_Lux; i++)
      {
         if (LicensePlateLux[i] == licensePlate)
         {
            tempval = i;
            break;
         }
